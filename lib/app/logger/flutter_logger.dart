...
class Logger {
  ...
  /// 设置用户自己的打印
  static set printer(Printer printer) {
    printer = printer;
  }
  ...
  static void d(Object? object, {String tag = 'Debug'}) {
    _printer.d(object, tag: tag);
  }

  static void i(Object? object, {String tag = 'Info'}) {
    _printer.i(object, tag: tag);
  }

  static void w(Object? object, {String tag = 'Warning'}) {
    _printer.w(object, tag: tag);
  }

  static void e(Object? object, {String tag = 'Error'}) {
