...
// import 'package:tradein/utils/helper.dart';
...
class PrettyDioLogger extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    logs = {'method': options.method}; //clear old log
    if (request) {
      _printRequestHeader(options);
    }
    if (requestHeader) {
      logs['params'] = options.queryParameters;
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) {
    ...
    logs['response'] = err.response;
    // Helper.sendSlackMessage(message: err.message, detail: logs.toString());
